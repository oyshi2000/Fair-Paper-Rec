...
dataset = pd.read_csv('/home/uoyshi/Documents/Research/paperRecommendation/paperRecommendation2/Datasets/synth.csv', index_col= 0)

'''overallPaperPool = pd.read_csv('/home/uoyshi/Documents/Research/paperRecommendation/editDatasets/FinalDatasets/papers_final-asian-withRace.csv', index_col=0)
sigchiPaperPool = pd.read_csv('/home/uoyshi/Documents/Research/paperRecommendation/editDatasets/sigcai_selected_papers.csv')
sigchiPaperPool.reset_index(drop=True, inplace=True)
sigcaiPaperTitle = sigchiPaperPool['Title'].to_list()

'''
authorFeatures = pd.read_csv('/home/uoyshi/Documents/Research/paperRecommendation/paperRecommendation2/Datasets/synth.csv')
authorFeatures['Authors'] = authorFeatures['Authors']
